...
if clic1 == True:
    ...
    pred = rdf.predict_proba(
        (X_test[n].reshape(1, -1))
    )  # il faut reshape le vecteur à tester. X_test[n].shape = (28, ) et rdf.predict attend un array de dimension 2.
